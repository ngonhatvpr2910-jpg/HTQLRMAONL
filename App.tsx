...
import { Settings, Package, RefreshCw, CloudOff, AlertTriangle, Users, Database } from 'lucide-react';
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-amber-800 bg-amber-50 hover:bg-amber-100 border border-amber-200 rounded-lg transition-colors shadow-xs"
            title="Đồng bộ & Nạp file dữ liệu cũ (.json / .xlsx / .csv)"
            id="header-btn-sync-old-data"
          >
            <Database className="w-3.5 h-3.5 text-amber-600" />
            <span className="hidden sm:inline">Nạp Dữ liệu cũ</span>
          </button>
